...
def test_main_reports_success_and_redacts_docker_logs(
    ...
    monkeypatch.setenv("DOTMD_SURREAL_RETRIEVAL_URL", "ws://surreal.example:8000/rpc")
    monkeypatch.setenv("DOTMD_SURREAL_RETRIEVAL_NAMESPACE", "dotmd")
    monkeypatch.setenv("DOTMD_SURREAL_RETRIEVAL_DATABASE", "production")
    monkeypatch.setenv("DOTMD_SURREAL_RETRIEVAL_USERNAME", secrets["username"])
    monkeypatch.setenv("DOTMD_SURREAL_RETRIEVAL_PASSWORD", secrets["password"])
