...
class SurrealSchemaPlan:
    ...
    def field_statements(self) -> tuple[str, ...]:
        return (
            ...
            build_field_statement("graph_nodes", "node_id", "string"),
            build_field_statement("graph_nodes", "labels", "array<string>"),
            build_field_statement("graph_nodes", "primary_label", "string"),
            build_field_statement("graph_nodes", "properties", "object FLEXIBLE"),
            build_field_statement("graph_edges", "source_id", "string"),
            build_field_statement("graph_edges", "source_labels", "array<string>"),
            build_field_statement("graph_edges", "target_id", "string"),
            build_field_statement("graph_edges", "target_labels", "array<string>"),
            build_field_statement("graph_edges", "edge_key", "option<string>"),
            build_field_statement("graph_edges", "relation_label", "string"),
            build_field_statement("graph_edges", "relation_type", "string"),
            build_field_statement("graph_edges", "weight", "float"),
            build_field_statement("graph_edges", "properties", "object FLEXIBLE"),
    ...
    def scalar_index_statements(self) -> tuple[str, ...]:
        return (
            ...
            build_index_statement("graph_nodes_node_id", "graph_nodes", "node_id"),
            build_index_statement(
                "graph_edges_source_target",
                "graph_edges",
