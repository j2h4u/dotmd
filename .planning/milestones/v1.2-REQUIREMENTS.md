# Requirements Archive: v1.2 FalkorDB Migration & Search Fix
...
- [x] **GRAPH-04**: Docker networking connects dotmd container to `graphiti_default` network for FalkorDB access
- [x] **GRAPH-05**: Full re-index with `--force` populates FalkorDB graph (~59 min, overnight run)
