...
- [x] 01-02-PLAN.md — Vector store delete, graph store delete with DETACH DELETE spike
...
- [x] 02-02-PLAN.md — Thread force parameter through DotMDService + CLI --force flag
